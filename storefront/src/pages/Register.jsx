...
export default function Register() {
  ...
  return (
    <div className="flex-grow w-full max-w-[450px] mx-auto px-margin-mobile py-10 sm:py-16 flex flex-col justify-center animate-fadeIn">
      ...
      <div className="bg-transparent sm:bg-surface-container-low rounded-2xl p-6 sm:p-8 border border-transparent sm:border-outline-variant/30 shadow-none sm:shadow-2xl">
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <p className="font-body-sm text-xs text-on-surface-variant mt-2">
            Join LUNARIS Athletics for premier racing technology.
          </p>
        </div>

        {/* Error Callout */}
        {error && (
          <div className="bg-error-container/20 border border-error-container text-error rounded-xl p-4 text-xs font-bold mb-6">
            {error}
          </div>
        )}
        ...
        {/* Toggle Account Exist */}
        <div className="text-center mt-6 pt-5 border-t border-outline-variant/20">
          <span className="text-xs text-on-surface-variant">Already have a LUNARIS account? </span>
